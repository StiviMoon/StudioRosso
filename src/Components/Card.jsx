...
const Card = ({ title, description, icon }) => {
  return (
    <div className="w-full sm:w-80 md:w-80 p-10 bg-white shadow-lg rounded-2xl cursor-pointer  space-y-6 relative overflow-hidden transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl hover:translate-y-1 hover:shadow-crema">
      {/* Icono centrado */}
